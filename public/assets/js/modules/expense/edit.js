		...
		init: function (n) {
			...
			$(document).on("click", ".editSupplier", function () {
				...
				$.ajax({
					...
					success: function (res) {
						if (res.status == 1) {
							$("#primarySupplierModal").find(".formTitle").html("Müşteri Bilgilerini Düzenle");
			...
			$(".addSupplierButton").on("click", function () {
				...
				$("#primarySupplierModal").find(".formTitle").html("Hızlı Müşteri Oluştur");
				$("#primarySupplierModal").modal("show");
