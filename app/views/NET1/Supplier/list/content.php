		...
		<div id="kt_content_container" class="container-xxl">
			...
			<div class="card">
				...
				<div class="card-body py-4">
					<!--begin::Table-->
					<table class="table align-middle table-row-dashed fs-6 gy-5" id="suppliers-table">
						<!--begin::Table head-->
						<thead>
						<!--begin::Table row-->
		...
		<div class="modal-dialog modal-dialog-centered mw-650px">
			...
			<div class="modal-content">
				...
				<div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
					<!--begin::Form-->
					<form id="addSupplierForm" enctype="multipart/form-data" class="form"
						  action="#">
						<input type="hidden" name="supplierType" value="INDIVIDUAL">
									...
									<div class="col-lg-12">
										...
										<div class="fv-row row mb-5">
											...
											<div
												...
												<!--begin::Label-->
												<label
													   class="required fw-bold fs-6 mb-2">Tedarikçi
													Adı</label>
												<!--end::Label-->
												<!--begin::Input-->
												<input type="text"
