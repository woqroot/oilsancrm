	...
	<div class="invoice-box">
		<table style="width:100%;" cellpadding="0" cellspacing="0">
						...
						<tr>
							...
							<td style="text-align:right;">
								<div style="border-radius:0 0 4px 0; border-right: 0px solid #c9c0c0;  padding-right:5px;">
									...
									&nbsp; <?= $sale["invoiceNumber"] ?>
									<hr style="width: 120px; border: 1px solid #dedede; margin-left: 55%;">
								</div>
								<div style="border-radius:0 0 4px 0; border-right: 0px solid #c9c0c0;  padding-right:5px;">
			...
			<tr class="total" style="">
				...
				<td></td>
				<td></td>
				<td style="font-size: 14px !important;"><b
							style="font-size: 13px !important;">Toplam:</b> <?= showBalance($sale['totalPriceWithVat'], $sale['fkCurrency']) ?>
				</td>
			</tr>
			<tr>
				<td></td>
...
file_put_contents('public/exports/' . $sale["invoiceNumber"] . "-" . date("YmdHis") . '.pdf', $output);
// Output the generated PDF to Browser
$npmailer->addAttachment('public/exports/' . $sale["invoiceNumber"] . "-" . date("YmdHis") . '.pdf');
foreach ($sendToMails as $sendToMail) {

	$npmailer->send($sendToMail, $subjectText, $bodyText);
}

echo json_encode(['status' => 1,'message' => 'E-posta başarıyla gönderildi.']);
