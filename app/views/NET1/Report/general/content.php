						...
						<div class="card-body">
							...
							<div class="card-titles d-flex flex-column">
								...
								<div class="d-flex align-items-center">
									<!--begin::Currency-->
									<span class="fs-4 fw-bold text-gray-400 me-1 align-self-start" id="NPtotalSuccessSalesCurrency">$</span>
									<!--end::Currency-->
									<!--begin::Amount-->
								...
								<!--end::Info-->
								<!--begin::Subtitle-->
								<span class="text-gray-400 pt-1 fw-bold fs-6">Satış Tutarı (<span id="NPcountSuccessSales">-</span>)</span>
								<!--end::Subtitle-->
							</div>
							<!--end::Title-->
						</div>
					...
					<div class="card card-flush mb-5 mb-xl-10">
						...
						<div class="card-body">
							...
							<div class="card-titles d-flex flex-column">
								...
								<div class="d-flex align-items-center">
									<!--begin::Amount-->
									<span class="fs-2hx fw-bolder text-dark me-2 lh-1 ls-n2" id="NPcountCreatedMissions">-</span>
									<!--end::Amount-->
					...
					<div class="card card-flush mb-5 mb-xl-10">
						...
						<div class="card-body">
							...
							<div class="card-titles d-flex flex-column">
								...
								<div class="d-flex align-items-center">
									<!--begin::Amount-->
									<span class="fs-2hx fw-bolder text-dark me-2 lh-1 ls-n2" id="NPcountCompletedMissions">-</span>
									<!--end::Amount-->
		...
		<div class="card card-xl-stretch mb-xl-8">
			...
			<div class="card-body d-flex flex-column">
				<div class="flex-grow-1">
					<div class="trialProductChart" data-kt-chart-color="primary" style="height: 200px"></div>
				</div>
				<div class="pt-5">
