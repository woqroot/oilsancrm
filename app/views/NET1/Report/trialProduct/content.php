		...
		<div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
			...
			<div class="d-flex align-items-center justify-content-end gap-2 gap-lg-3">
				...
				<div class="px-4 w-100">
					<!--begin::Select-->
					<select name="productID" data-control="select2"
							data-placeholder="Tüm Ürünler"
							data-allow-clear="true"
							class="form-select form-select-solid selectProduct">
						<option value=""></option>
						<?php
						foreach ($products as $product) {
							?>
							<option value="<?= $product["productId"] ?>"><?= $product["name"] . " - " . $product["brandName"] ?></option>
							<?php
						}
						?>
					</select>
	...
	<div class="post d-flex flex-column-fluid" id="kt_post">
		...
		<div id="kt_content_container" class="container-xxl">
						...
						<div class="card-body">
							...
							<div class="card-titles d-flex flex-column">
								...
								<div class="d-flex align-items-center">
									<!--begin::Amount-->
									<span class="fs-2 fw-bolder text-dark me-2 lh-1 ls-n2" id="NPpendings">-</span>
									<!--end::Amount-->

								</div>
								<!--end::Info-->
								<!--begin::Subtitle-->
								<span class="text-gray-400 pt-1 fw-bold fs-6">Devam Eden Süreç <?= questionIcon("Seçtiğiniz aralıkta başlayan deneme süreçlerinin henüz sonuçlanmayan kısmını ifade eder.") ?></span>
								<!--end::Subtitle-->
							</div>
							<!--end::Title-->
						</div>
					...
					<div class="card card-flush mb-5 mb-xl-10">
						...
						<div class="card-body">
							...
							<div class="card-titles d-flex flex-column">
								...
								<div class="d-flex align-items-center">
									<!--begin::Amount-->
									<span class="fs-2 fw-bolder text-dark me-2 lh-1 ls-n2" id="NPsuccess">-</span>
									<!--end::Amount-->

								</div>
								<!--end::Info-->
								<!--begin::Subtitle-->
								<span class="text-gray-400 pt-1 fw-bold fs-6">Başarılı Süreç <?= questionIcon("Seçtiğiniz aralıkta başlayan deneme süreçlerinin kaç tanesinin başarılı sonuçlandığını ifade eder.") ?></span>
								<!--end::Subtitle-->
							</div>
							<!--end::Title-->
						</div>
					...
					<div class="card card-flush mb-5 mb-xl-10">
						...
						<div class="card-body">
							...
							<div class="card-titles d-flex flex-column">
								...
								<!--end::Info-->
								<!--begin::Subtitle-->
								<span class="text-gray-400 pt-1 fw-bold fs-6">Başarısız Süreç <?= questionIcon("Seçtiğiniz aralıkta başlayan deneme süreçlerinin kaç tanesinin başarısız sonuçlandığını ifade eder.") ?></span>
								<!--end::Subtitle-->
							</div>
							<!--end::Title-->
						</div>
			...
			<div class="d-flex justify-content-center">
				<div class="col-lg-4 mx-3 card-stretch hideAndShow">
					<div style="    height: 94%;" class="card card-stretch mb-5 mb-xl-10">
						<div class="card-header">
							<h3 class="card-title align-items-start flex-column my-7">
								...
								<span class="text-gray-400 mt-1 fw-bold fs-6">Seçilen aralıkta başlatılan deneme süreçlerinin ürüne göre dağılımı</span>
							</h3>
						</div>
						<!--end::Header-->
						<div class="card-body pt-0 pb-1">
							<div id="productPieChart" style="margin-top: 25%;
    margin-left: 15%;" class="min-h-auto"></div>
				...
				<div class="col-lg-4 mx-3 card-stretch hideAndShow">
					<div style="    height: 94%;" class="card card-stretch mb-5 mb-xl-10">
						<div class="card-header">
							<h3 class="card-title align-items-start flex-column my-7">
								<span class="card-label fw-bolder text-gray-800">Geri Teslim Alma Oranı</span>
								<span class="text-gray-400 mt-1 fw-bold fs-6">Deneme süreçlerine ait verilerin güncel durumu</span>
							</h3>
						</div>
						<!--end::Header-->
