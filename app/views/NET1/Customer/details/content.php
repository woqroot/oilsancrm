												...
												<div class="d-flex flex-wrap py-5">
													...
													<div class="flex-equal me-5">
														<table class="table table-flush fw-bold gy-1">
															...
															<tr>
																<td class="text-muted min-w-125px w-125px">Departman/Pozisyon</td>
													...
													<div class="flex-equal">
														<table class="table table-flush fw-bold gy-1">
															<tbody>
															<tr>
																<td class="text-muted min-w-125px w-125px">E-posta Adresi
																</td>
																<td class="text-gray-800"><?=$contact["email"]?></td>
															</tr>
															<tr>
																<td class="text-muted min-w-125px w-125px">Telefon Numarası</td>
