				...
				<div class="card-body py-4">
					...
					<table class="table align-middle table-row-dashed fs-6 gy-5 np-datatable">
						...
						<tr class="text-start text-muted fw-bolder fs-7 text-uppercase gs-0">
							...
							<th class="min-w-125px">Müşteri Sayısı</th>
						...
						<?php
						$counter = 0;
						foreach ($customerSources as $item) {
							$counter++;
							?>
							<tr data-id="<?= $item["customerSourceId"] ?>">
								<td><?= $counter; ?></td>
								<td><?= $item["title"] ?></td>
								<td><span class="badge badge-light-primary"><?=$item["countCustomer"]?></span></td>
								<td>
