					...
					<div class="modal-content">
						...
						<form class="form" action="#" id="kt_modal_add_event_form">
							...
							<div class="modal-header">
								<!--begin::Modal title-->
								<h2 class="fw-bolder" data-kt-calendar="title">Etkinlik Oluştur</h2>
								<!--end::Modal title-->
								<!--begin::Close-->
							...
							<div class="modal-body py-10 px-lg-17">
								...
								<div class="row">
									<!--begin::Input group-->
									<div class="col-8 fv-row mb-9">
										<!--begin::Label-->
										<label class="fs-6 fw-bold required mb-2">Etkinlik Başlığı</label>
										<!--end::Label-->
										<!--begin::Input-->
									...
									<!--end::Input group-->
									<!--begin::Input group-->
									<div class="col-4 fv-row mb-9">
										<!--begin::Label-->
										<label class="fs-6 fw-bold required mb-2">Etkinlik Tipi</label>
										<!--end::Label-->
										<!--begin::Input-->
										<select name="fkEventCategory" id="fkEventCategory"
								...
								<div class="fv-row mb-9">
									...
									<!--begin::Input-->
									<input type="text" class="form-control form-control-solid" placeholder=""
										   name="calendar_event_explanation"/>
									<!--end::Input-->
								</div>
								<!--end::Input group-->
								<!--begin::Input group-->
								<div class="fv-row mb-9 d-none">
									<!--begin::Label-->
									<label class="fs-6 fw-bold mb-2">Konum</label>
									<!--end::Label-->
									<!--begin::Input-->
									<input type="text" class="form-control form-control-solid" placeholder=""
								...
								<div class="fv-row mb-9">
									...
									<label class="form-check form-check-custom form-check-solid">
										...
										<span class="form-check-label fw-bold" for="kt_calendar_datepicker_allday">Tüm Gün</span>
									</label>
									<!--end::Checkbox-->
								</div>
								<!--end::Input group-->
								...
								<div class="row row-cols-lg-2 g-10">
									...
									<div class="col" data-kt-calendar="datepicker">
										<div class="fv-row mb-7">
											<!--begin::Label-->
											<label class="fs-6 fw-bold mb-2">Başlangıç Saati</label>
											<!--end::Label-->
											<!--begin::Input-->
											<input class="form-control form-control-solid"
								...
								<div class="row row-cols-lg-2 g-10">
									...
									<div class="col" data-kt-calendar="datepicker">
										<div class="fv-row mb-7">
											<!--begin::Label-->
											<label class="fs-6 fw-bold mb-2">Bitiş Saati</label>
											<!--end::Label-->
											<!--begin::Input-->
											<input class="form-control form-control-solid"
							...
							<div class="modal-footer flex-center">
								<!--begin::Button-->
								<button type="reset" id="kt_modal_add_event_cancel" class="btn btn-light me-3">İptal
								</button>
								<!--end::Button-->
								<!--begin::Button-->
