										...
										<div class="col-lg-5 me-auto">
											<div class="mb-5">
												<select name="supplierID"
														class="selectSupplier form-control form-control-solid">

												</select>
												<a href="javascript:void(0)" class="addSupplierButton">
						...
						<div class="card-body p-10">
							...
							<div class="mb-8">
								...
								<label class="form-check form-switch form-switch-sm form-check-custom form-check-solid flex-stack mb-5">
									<span class="form-check-label ms-0 fw-bolder fs-6 text-gray-700">Tamamı Ödendi</span>
									<input class="form-check-input isPaid" type="checkbox" name="isPaid"
										   value="1"/>
								</label>
								<div class="mb-3 fkAccountWrapper">
									<!--begin::Label-->
									<label class="form-label fw-bolder fs-6 text-gray-700">Ödeme Yapılan Hesap</label>
									<!--end::Label-->
									<!--begin::Select-->
								...
								<div class="mb-8 fkAccountWrapper">
									...
									<!--end::Label-->
									<!--begin::Select-->
									<input type="text" class="form-control form-control-solid paymentDate"
										   value="<?= date("d M Y") ?>" name="paymentDate">
									<!--end::Select-->
								</div>
								<!--end::Option-->
...
<!--end::Content-->
<div class="modal fade" id="primarySupplierModal" data-bs-backdrop="static"
	...
	<div class="modal-dialog modal-dialog-centered mw-650px">
		...
		<div class="modal-content">
			...
			<div class="modal-header" id="kt_modal_add_user_header">
				<!--begin::Modal title-->
				<h2 class="fw-bolder formTitle">Hızlı Tedarikçi Oluştur</h2>
				<!--end::Modal title-->
				<!--begin::Close-->
			...
			<div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
				<!--begin::Form-->
				<form id="primarySupplierForm" enctype="multipart/form-data" class="form"
					  action="#">
							...
							<div class="col-lg-12">
								<div class="fv-row row mb-5">
									...
									<div class="col-md-12 col-sm-12 fv-row">
										<!--begin::Label-->
										<label  class="required fw-bold fs-6 mb-2">Tedarikçi Adı</label>
										<!--end::Label-->
										<!--begin::Input-->
										<input type="text"
											   required
