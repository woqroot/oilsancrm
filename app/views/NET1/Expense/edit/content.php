					...
					<div class=" card rounded-0 h-100">
						<div class="card-body">
							...
							<ul class="nav nav-tabs nav-pills border-0 flex-row flex-md-column mb-3 mb-md-0 fs-6">
								...
								<li class="nav-item w-md-150px me-0">
									<a class="nav-link" data-bs-toggle="tab" href="#payments">Ödemeler</a>
								</li>
								<li class="nav-item w-md-150px me-0">
											...
											<div class="row gx-10 mb-5">
												...
												<div class="col-lg-6 supplierInformation">
													...
													if ($supplier) {
														...
														?>
														<div class="mb-1">
															<h6 class="name text-gray-600">Tedarikçi Seçimi Yok
															</h6>
														</div>
														<?php
													}
							...
							<div class="card">
								...
								<div class="card-header border-0 pt-6">
									...
									<div class="card-toolbar">
										...
										<div class="d-none" id="exportTitle">#<?= $expense["invoiceNumber"] ?> Ödeme
	...
	<div class="modal-dialog modal-dialog-centered mw-750px">
		...
		<div class="modal-content">
			...
			<div class="modal-header" id="kt_modal_add_user_header">
				<!--begin::Modal title-->
				<h2 class="fw-bolder formTitle">Ödeme Ekle</h2>
				<!--end::Modal title-->
				<!--begin::Close-->
...
<div class="modal fade" id="editPaymentModal" data-bs-backdrop="static"
	...
	<div class="modal-dialog modal-dialog-centered mw-750px">
		...
		<div class="modal-content">
			...
			<div class="modal-header" id="kt_modal_add_user_header">
				<!--begin::Modal title-->
				<h2 class="fw-bolder formTitle">Ödeme Detay <i
				...
				<div>
					...
					<button data-bs-toggle="tooltip" title="Ödeme kaydını kalıcı olarak sil"
