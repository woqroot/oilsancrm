...
--
-- Anamakine: 127.0.0.1
-- Üretim Zamanı: 18 Tem 2022, 22:54:50
...
(NULL, '2022-06-27 05:54:55', '2022-04-11 22:54:23', 2, 'companyInformation', '{\"name\":\"Netpus Yaz\\u0131l\\u0131m\",\"address\":\"Cenneto\\u011flu Mh. Ye\\u015fillik Cd. No 228-230 Karaba\\u011flar \\/ \\u0130ZM\\u0130R\",\"email\":\"info@ahmetcakmak.net\",\"taxNumber\":\"50167268218\",\"taxOffice\":\"Gaziemir VD\",\"phone\":\"0(232) 332 1102\"}');
...
--
-- Tablo için tablo yapısı `paymentintegration`
--
...
CREATE TABLE `paymentintegration` (
  ...
  `createdAt` datetime NOT NULL DEFAULT current_timestamp(),
  `paymentIntegrationId` int(11) NOT NULL,
  `title` varchar(255) NOT NULL,
  `merchantId` varchar(255) DEFAULT NULL,
  `merchantKey` varchar(255) DEFAULT NULL,
  `merchantSalt` varchar(255) DEFAULT NULL,
  `serviceName` varchar(255) DEFAULT NULL,
  `formLabels` longtext NOT NULL DEFAULT '{}'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Tablo döküm verisi `paymentintegration`
--

INSERT INTO `paymentintegration` (`deletedAt`, `updatedAt`, `createdAt`, `paymentIntegrationId`, `title`, `merchantId`, `merchantKey`, `merchantSalt`, `serviceName`, `formLabels`) VALUES
('2022-07-18 22:13:53', '2022-07-18 23:14:17', '2022-07-18 23:14:17', 1, 'PayTR', 'ID', 'Key', 'Salt', 'paytr', '{}');
...
INSERT INTO `sale` (`deletedAt`, `updatedAt`, `createdAt`, `saleId`, `token`, `invoiceNumber`, `invoiceDate`, `totalPrice`, `totalVat`, `totalPriceWithVat`, `balance`, `notes`, `invoiceNotes`, `fkCurrency`, `fkCustomer`) VALUES
(NULL, '2022-07-18 15:54:40', '2022-07-18 15:54:40', 1, '123123123', 2022001, '2022-07-18', '1000.0000', '180.00', '1180.00', '1180.00', 'asdfasdfdas', NULL, 1, 1);
...
(NULL, '2022-07-18 23:54:17', '2022-04-08 20:22:07', 1, 'Ahmet', 'ÇAKMAK', 'ahmet@netpus.com.tr', '123123', '905079747767', NULL, 'saedfasdf', 'light', '2022-07-18 23:54:17', 1),
...
--
-- Tablo için indeksler `paymentintegration`
--
ALTER TABLE `paymentintegration`
  ADD PRIMARY KEY (`paymentIntegrationId`);
...
--
-- Tablo için AUTO_INCREMENT değeri `paymentintegration`
--
ALTER TABLE `paymentintegration`
  MODIFY `paymentIntegrationId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
